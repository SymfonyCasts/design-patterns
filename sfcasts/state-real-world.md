...
This is the State pattern in action. The "state" of the car hasn't changed; We've only changed how an internal element of the system works. *That's* the Strategy pattern.

## Conclusion

Okay, that's the State pattern in a nutshell. Let's go over some of the pros and cons:

✅ First, the State pattern allows your objects to change behavior when their internal state changes, and it can even hide what state the object is in.
